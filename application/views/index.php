...
<html>
	<head>
		...
		<link rel='stylesheet' type='text/css' href="bs/docs/assets/css/bootstrap-responsive.css" />
	...
	<body>
		<div class="container">
			...
			<table cellpadding=10 style="width:100%;" class="table_short_text">
				...
				<tr><td>Permanent Address: </td><td><input type='text' id="perm_address" /></td><td>Contact Number: </td><td><input type='text' id="contact" /></td></tr>
			</table><hr />
			...
			<div id="torInner"></div>
			<br /><br />
			<table><tr><td><button type="button" class="btn btn-primary" data-toggle="button" id="certification">Certification (<i>Specify</i>): </button></td><td>&nbsp;&nbsp;&nbsp; <input type='text' /></td></tr></table><br />
			<button type="button" class="btn btn-primary" data-toggle="button" id="diploma">Diploma </button><hr /><br />
			...
			<table cellpadding=10 style="width:100%;">
				<tr><td>First Attendance in the institution: </td><td>
					...
					<tr><td>Number of Semesters and Summers: </td><td><input type='text' id="sum_sem" /></td></tr>
					<tr><td>Graduation Date: </td><td><select id="grad_month">
						...
						?>
					</select></td><td><select id="grad_yr" style="width:120px;"><?php for($i=$year;$i>=$end_date;$i--){ ?><option value="<?php echo $i; ?>"><?php echo $i; ?></option><?php }?></select></td></tr>
			</table><hr />
