<div class='container-fluid'>
		 ...
		 <form class="form-search pull-right" action="<?php echo base_url('accounting/searchRequests'); ?>" method="get">
              <div class="input-prepend input-append">
                  ...
                  <input class="span3" name="q" class="span2" id="appendedPrependedDropdownButton" type="text">
                      <div class="btn-group">
		...
		<table class="table table-fluid table-bordered table-striped table-hover" >
			...
			<tbody>
                	<?php if(isset($results['result']) && !empty($results['result'])){?>
                	<?php foreach( $results['result'] as $key => $value): ?>
